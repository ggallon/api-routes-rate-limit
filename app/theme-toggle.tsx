...
export function ThemeToggle(
  { displayTheme }: { displayTheme: boolean } = { displayTheme: false },
) {
      ...
      <button
        ...
        className={`inline-flex ${
          isHovering && !isHoveringOverride
            ...
            : ""
        } theme-system:!bg-inherit rounded-sm bg-gray-200 p-2 transition-[background-color]
                  active:bg-gray-300
                  dark:bg-[#313131]
